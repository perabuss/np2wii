...
/* Yeah, I (SquidMan) haxxed this to use my font format (couldn't be bothered
 * to correctly convert it. If you can't win the game, change the rules!
 */
		 ...
		 int x, int y, const char *text)
{
	...
	srcrect.w = dstrect.w = 16;
	srcrect.x = 0;
	srcrect.y = charoffset * 16;
	dstrect.x = x - charoffset * 16;
